...
if /i "%~1"=="Release" (
    ...
    set CONFIG=Debug
    set CommonCompilerFlags=-DENGINE_DEBUG -DDEBUG -diagnostics:column -std:c++20 -WL -Od -nologo -fp:fast -fp:except- -Gm- -GR- -EHsc- -Zo -Oi -WX -Wall -FC -Z7 -GS- -Gs9999999 -utf-8 %INCLUDES%
